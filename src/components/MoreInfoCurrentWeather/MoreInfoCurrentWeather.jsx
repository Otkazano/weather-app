  ...
  return (
    <>
      {weatherData.currentConditions ? (
        <>
          <BurgerMenuButton onClick={handleClick} isOpen={isOpen} hidden={showButton} />
          <aside
          ...
          >
            ...
            <div className="px-3 pb-1 flex justify-between items-center gap-2">
              ...
              <p className="text-lg  font-medium truncate sm:text-base">
                {Math.round(weatherData.currentConditions.pressure * 0.75006156)}
                мм рт. ст.
              </p>
            </div>

            <div className="flex px-3 pb-1 pt-7 justify-around items-center gap-2">
              <Clock title={'Рассвет'} weatherData={weatherData.currentConditions.sunrise} />
              <Clock title={'Закат'} weatherData={weatherData.currentConditions.sunset} />
            </div>
