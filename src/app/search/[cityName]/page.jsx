  ...
  return (
    <main className='flex flex-col grow max-w-[1440px] mx-auto w-full relative'>
      {!isError ? (
        ...
        <section className='flex flex-col grow text-white mx-auto justify-center gap-6 w-full p-5'>
          <h1 className='drop-shadow-lg text-5xl text-center font-semibold sm:text-3xl'>
            Город не найден
          </h1>
          <button
            type='button'
